...
import com.cizotech.emma.databinding.ActivityStylingProductBinding;
...
public class StylingProductActivity extends AppCompatActivity implements View.OnClickListener {
    ActivityStylingProductBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_styling_product);
        ...
        hairePojos.add(new HairePojo("CURL DEFINING","",false));
        hairePojos.add(new HairePojo("HEAT PROTECTING","",false));
        hairePojos.add(new HairePojo("SHINE ENHANCING","",false));
        hairePojos.add(new HairePojo("VOLUMIZING","",false));
        hairePojos.add(new HairePojo("STRONG HOLD","",false));
    ...
    public void onClick(View view) {
        //startActivity(new Intent(HairstyleActivity.this,HomeActivity.class));
    }
