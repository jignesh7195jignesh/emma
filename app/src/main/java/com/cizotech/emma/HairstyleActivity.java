...
import com.cizotech.emma.databinding.ActivityHairstyleBinding;
...
public class HairstyleActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_hairstyle);
        hairstyleAdapter=new HairstyleAdapter(this,hairePojos);
        binding.rcHairestyle.setLayoutManager(new LinearLayoutManager(HairstyleActivity.this,LinearLayoutManager.HORIZONTAL, true));
        binding.rcHairestyle.setAdapter(hairstyleAdapter);

        hairePojos.add(new HairePojo("HI","",false));
        hairePojos.add(new HairePojo("HI","",false));
        hairePojos.add(new HairePojo("HI","",false));
    ...
    public void onClick(View view) {
        startActivity(new Intent(HairstyleActivity.this,ChemicalActivity.class));
    }
    ...
    public class HairstyleAdapter extends RecyclerView.Adapter<HairstyleAdapter.ViewHolder>{
        ...
        public HairstyleAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new HairstyleAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.row_hairestyle,parent,false));
        }
