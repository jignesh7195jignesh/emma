...
import com.cizotech.emma.databinding.ActivityShampooBinding;
...
public class ShampooActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_shampoo);
        ...
        hairePojos.add(new HairePojo("MOISTURIZING","",false));
        hairePojos.add(new HairePojo("COLOR PERFECTING","",false));
        hairePojos.add(new HairePojo("CLARIFYING","",false));
        hairePojos.add(new HairePojo("SULFATE FREE","",false));
    ...
    public void onClick(View view) {
        startActivity(new Intent(ShampooActivity.this,LeaveInTreatmentActivity.class));
    }
