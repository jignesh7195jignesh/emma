...
import com.cizotech.emma.databinding.ActivityRinseBinding;
...
public class RinseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_rinse);
        ...
        hairePojos.add(new HairePojo("REPAIRING","",false));
    ...
    public void onClick(View view) {
        startActivity(new Intent(RinseActivity.this,ShampooActivity.class));
    }
